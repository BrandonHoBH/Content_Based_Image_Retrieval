...
def Search_Algorithm(querypath, query):
    mindistance = 86 
    minpath = ''
...
querypath = os.path.join(os.getcwd(), 'Search')
querydir = os.listdir(querypath)
querypath = os.path.join(os.getcwd(), 'Search', querydir[0])

Search_Algorithm(querypath, querydir[0])
